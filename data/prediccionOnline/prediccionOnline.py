...
def actualizarVectores(evento):
    ...
    if (evento["eventType"] in ["Truck departed", "Truck departed to depot"]):
        ...
        print('Actualizado ', evento["simulationId"],evento["truckId"])
...
def prediccionDeTiempoDeViaje(evento):
    ...
    print('La estimacion era: ', vector[0], '. La prediccion es: ', prediccion)
    return prediccion
...
def escribirEnKafka(prediccion):
    ...
    mensaje = json.dumps(prediccion[0]) # DECIDIR EL FORMATO DE LOS MENSAJES CON LAS PREDICCIONES
